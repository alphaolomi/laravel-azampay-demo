    ...
    <main class="bg-white px-4 pb-5 pt-5 sm:px-6 sm:pt-5 lg:px-8 lg:pt-5">
      <div class="container mx-auto">
        <div class="max-w-xl">
          ...
          <p class="h4 text-muted mt-2">Your order #14034056 has shipped and will be with you soon.</p>
        ...
        <section aria-labelledby="order-heading" class="border-top border-secondary mt-5">
            ...
            <div class="flex-grow-1 flex-column ml-3 flex">
              <div>
                <h4 class="h5 text-dark">
                  <span>Cold Brew Bottle</span>
                </h4>
                <p class="text-muted mt-2 text-sm">This glass bottle comes with a mesh insert for steeping tea or
          ...
          <div class="ml-sm-0 pl-sm-6 ml-4 mt-3">
              ...
              <div>
                ...
                <dd class="text-dark mt-2">
                  <address class="not-italic">
                    <span class="d-block">Kristin Watson</span>
                    <span class="d-block">7363 Cynthia Pass</span>
                    <span class="d-block">Toronto, ON N3Y 4H8</span>
                  </address>
                </dd>
              </div>
              <div>
            ...
            <dl class="border-top border-secondary space-y-3 pt-3 text-sm">
              ...
              <div class="d-flex justify-content-between">
                <dt class="font-weight-bold text-dark">Total</dt>
                <dd class="text-dark">$23.00</dd>
              </div>
            </dl>
          </div>
        </section>
